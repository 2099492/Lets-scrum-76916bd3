...
function display_intro_instructions () {
   ...
   ctx.fillText("klik om te starten", myCanvas.width / 2, myCanvas.height / 4);
   }
function display_game_over () {
   ...
   ctx.font= "20px Arial";
   ctx.fillText("klik om opnieuw te beginnen", myCanvas.width / 2, 300);
   }
...
function Do_a_Frame () {
 ...
 setInterval(Do_a_Frame, 1000/FPS);0
